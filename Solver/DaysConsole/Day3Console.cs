...
public static class Day3Console
{
	...
	public class P1
	{
		...
		public P1()
		{
			...
			Console.WriteLinesAt("1 bits :", 1, gammaY + 1);
			Console.WriteLinesAt("bit    :", 1, gammaY + 2);
			Console.WriteLinesAt("value  :", 1, gammaY + 3);
			...
			Console.WriteLinesAt("1 bits :", 1, epsilonY + 1);
			Console.WriteLinesAt("bit    :", 1, epsilonY + 2);
			Console.WriteLinesAt("value  :", 1, epsilonY + 3);
		...
		public void SetGammaEpsilon(IEnumerable<bool> gammaBits, long gamma, IEnumerable<bool> epsilonBits, long epsilon)
		{
			...
			Console.WriteLinesAt(gamma.ToString(), 10, gammaY + 3);
			Console.WriteLinesAt(epsilon.ToString(), 10, epsilonY + 3);
		}
